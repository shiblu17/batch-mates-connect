          ...
          {MOCK_PHOTOS.map((photo, i) => {
            ...
            return (
              <motion.div
                ...
                className="break-inside-avoid rounded-xl overflow-hidden shadow-card group"
              >
                <div
                  className={`bg-gradient-to-br ${photo.color} flex items-center justify-center text-4xl`}
                  style={{ height }}
                >
                  🎓
                </div>
